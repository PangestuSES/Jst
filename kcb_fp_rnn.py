...
Original file is located at
    https://colab.research.google.com/drive/1Kg6ctXSXhUt6D1zWyVqFgxLF_q0zFPrA
"""
...
model = Sequential([
    SimpleRNN(units = 25, input_shape= (5,1), activation = 'elu'),
...
# training the model
RNN_history = model.fit(x = x_train,
                        y = y_train,
                        batch_size= 10,
                        epochs = 100,
...
plt.title('RNN - Training & Validation Acc.', fontsize=16, weight='bold')
...
plt.title('RNN - Training & Validation Loss', fontsize=15, weight='bold')
plt.xlabel('Epoch', fontsize=15, weight='bold')
...
# Ringkasan dari metrik evaluasi
